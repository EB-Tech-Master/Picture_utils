...
class Labelme2YOLO(object):
    ...
    def _make_train_val_dir(self):
        ...
        yolo_path =self._label_dir_path
    ...
    def _save_yolo_label(self, json_name, label_dir_path, yolo_obj_list):
    ...
    def _save_dataset_yaml(self):
        ...
        with open(yaml_path, 'w+') as yaml_file:
            yaml_file.write('train: ../Path to train later\n\n')
            yaml_file.write('val: ../Path to val later\n\n')
            yaml_file.write('test: ../Path to val later\n\n')
